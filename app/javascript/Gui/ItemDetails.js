...
ItemDetails.onFocus = function() {
	Helper.setControlButtons(Main.messages.LabButtonFavourite, Main.messages.LabButtonWatched, ItemDetails.trailerState == sf.service.VideoPlayer.STATE_PLAYING ||
	ItemDetails.trailerState == sf.service.VideoPlayer.STATE_BUFFERING ? Main.messages.LabButtonFullScreen : null, MusicPlayer.Status == "PLAYING" || MusicPlayer.Status == "PAUSED" ? Main.messages.LabButtonMusic : null, Main.messages.LabButtonReturn);
};
...
ItemDetails.start = function(title, url, selectedItem) {
	...
	if (this.ItemData.UserData.PlaybackPositionTicks > 0) {
		...
		tvEpisodeOptions += "<div id='tvEpisodeResume' class='filmListSingle'><div class='filmListSingleImage' style=background-image:url(images/menu/Resume-46x37.png)></div><div class='showListSingleTitle'><div class='showListTextOneLineFilm'>" + Main.messages.LabRESUME + " - " + Support.convertTicksToTimeSingle(this.resumeTicksSamsung) + "</div></div></div>";
	}
	...
	if (this.ItemData.Type == "Trailer" && this.trailersEnabled){
		...
		tvEpisodeOptions += "<div id='tvEpisodePlay' class='filmListSingle'><div class='filmListSingleImage' style=background-image:url(images/menu/Play-46x37.png)></div><div class='showListSingleTitle'><div class='showListTextOneLineFilm'>" + Main.messages.LabPLAYTRAILER + "</div></div></div>";
	} else if (this.ItemData.LocationType != "Virtual") {
		this.menuItems.push("tvEpisodePlay");
		tvEpisodeOptions += "<div id='tvEpisodePlay' class='filmListSingle'><div class='filmListSingleImage' style=background-image:url(images/menu/Play-46x37.png)></div><div class='showListSingleTitle'><div class='showListTextOneLineFilm'>" + Main.messages.LabPLAY + "</div></div></div>";
	}

	if (this.ItemData.Chapters.length > 0) {
		this.menuItems.push("tvEpisodeChapters");
		tvEpisodeOptions += "<div id=tvEpisodeChapters' class='filmListSingle'><div class='filmListSingleImage' style=background-image:url(images/menu/Film-46x37.png)></div><div class='showListSingleTitle'><div class='showListTextOneLineFilm'>" + Main.messages.LabCHAPTERS + "</div></div></div>";
	}
	...
	if (this.ItemData.Type == "Episode") {
		...
		if (this.EpisodeData.Items.length > 1) {
			...
			tvEpisodeOptions += "<div id='tvEpisodeEpisodes' class='filmListSingle'><div class='filmListSingleImage' style=background-image:url(images/menu/tv-46x37.png)></div><div class='showListSingleTitle'><div class='showListTextOneLineFilm'>" + Main.messages.LabMOREEPISODES + "</div></div></div>";
		}

		//Add Cast
		if (this.SeriesData.People.length > 1) {
			this.menuItems.push("tvEpisodeCast");
			tvEpisodeOptions += "<div id='tvEpisodeCast' class='filmListSingle'><div class='filmListSingleImage' style=background-image:url(images/menu/Person-46x37.png)></div><div class='showListSingleTitle'><div class='showListTextOneLineFilm'>" + Main.messages.LabCAST + "</div></div></div>";
		}

		//Add to Playlist Option
		if (this.ItemData.LocationType != "Virtual") {
			this.menuItems.push("tvEpisodePlaylist");
			tvEpisodeOptions += "<div id='tvEpisodePlaylist' class='filmListSingle'><div class='filmListSingleImage' style=background-image:url(images/menu/AddToList-60x37.png)></div><div class='showListSingleTitle'><div class='showListTextOneLineFilm'>" + Main.messages.LabADDTOPLAYLIST + "</div></div></div>";
		}
		...
		if (this.SimilarFilms.Items.length > 0) {
			...
			tvEpisodeOptions += "<div id='tvEpisodeSuggested' class='filmListSingle'><div class='filmListSingleImage' style=background-image:url(images/menu/Movies-46x37.png)></div><div class='showListSingleTitle'><div class='showListTextOneLineFilm'>" + Main.messages.LabSUGGESTED + "</div></div></div>";
		}
